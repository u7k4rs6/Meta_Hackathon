...
def grade(action_data: dict) -> float:
    """Standardized grader entry point for task3_hard.

    Evaluates whether the agent correctly identified the wrong-operator bug.
    Returns a score strictly between 0 and 1 (exclusive).
    """
    TARGET_LINE = 10
    TARGET_BUG_TYPE = "wrong-operator"
